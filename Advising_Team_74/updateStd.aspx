<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="updateStd.aspx.cs" Inherits="Advising_Team_74.updateStd" %>
...
<html lang="en">
  ...
  <body>
    ...
    <h2 class="mb-4">Update student status:</h2>
    ...
    <!-- Additional content or formatting here -->
        Student id:<asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="TextBox1" ErrorMessage="RequiredFieldValidator" ForeColor="Red">*</asp:RequiredFieldValidator>
        ...
        <asp:Label ID="Label2" runat="server" Font-Size="Small" ForeColor="Red" Text="Student not found" Visible="False"></asp:Label>
        <br />
        <br />
        <asp:Button ID="Button1" runat="server" Text="Update" class="small-button" OnClick="Update_Student_Status"/>
</div>
		</div>
