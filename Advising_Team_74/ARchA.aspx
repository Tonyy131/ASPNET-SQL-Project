<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ARchA.aspx.cs" Inherits="Advising_Team_74.ARchA" %>
...
<html lang="en">
  ...
  <body>
    ...
    <h2 class="mb-4">Approve, Reject extra credit hours requests:</h2>
...
&nbsp;<asp:Label ID="Label3" runat="server" Font-Size="Small" ForeColor="Red" Text="Request not found" Visible="False"></asp:Label>
    <!-- Additional content or formatting here -->
        ...
        <asp:Button ID="Button1" runat="server" Text="Update request status" class="small-button" OnClick="Extra_CH_Request"/>
