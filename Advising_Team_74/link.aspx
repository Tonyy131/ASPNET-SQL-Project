<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="link.aspx.cs" Inherits="Advising_Team_74.link" %>
...
<html lang="en">
  ...
  <body>
    ...
    <h2 class="mb-4">Link instructor :</h2>
    <div style="font-family: 'Sitka Heading'; font-size: xx-large; font-weight: bolder; text-transform: uppercase; color: #000080;">
        <form id="form1" runat="server">
		    Instructor id:<asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="ins" ErrorMessage="RequiredFieldValidator" ForeColor="Red">*</asp:RequiredFieldValidator>
		    ...
		    <br />
            course id:<asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="TextBox2" ErrorMessage="RequiredFieldValidator" ForeColor="Red">*</asp:RequiredFieldValidator>
		    ...
		    <br />
            slot id:<asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="TextBox3" ErrorMessage="RequiredFieldValidator" ForeColor="Red">*</asp:RequiredFieldValidator>
		    ...
		    <asp:Label ID="Label2" runat="server" ForeColor="Red" Text="Please check the ids!!" Visible="False" Font-Size="Small"></asp:Label><br />
            <asp:Button ID="Button1" runat="server" Text="Link" class="small-button" OnClick="Link_instructor_to_course_on_specific_slot"/>
		</form>
