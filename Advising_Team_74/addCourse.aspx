<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="addCourse.aspx.cs" Inherits="Advising_Team_74.addCourse" %>
  ...
  <body>
    ...
    <div style="font-family: 'Sitka Heading'; font-size: xx-large; font-weight: bolder; text-transform: uppercase; color: #000080;">
        <form id="form1" runat="server">
		    Major:<asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="TextBox1" ErrorMessage="RequiredFieldValidator" ForeColor="Red">*</asp:RequiredFieldValidator>
            <br />
            <asp:TextBox ID="TextBox1" runat="server" class="custom-textbox"></asp:TextBox>
		    <br />
            Semester:<asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="TextBox2" ErrorMessage="RequiredFieldValidator" ForeColor="Red">*</asp:RequiredFieldValidator>
		    ...
		    <br />
            No. of credit hours:<asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="TextBox3" ErrorMessage="RequiredFieldValidator" ForeColor="Red">*</asp:RequiredFieldValidator>
            <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ControlToValidate="TextBox3" ErrorMessage="RegularExpressionValidator" ForeColor="Red" ValidationExpression="\d+">*</asp:RegularExpressionValidator>
            <br />
            <asp:TextBox ID="TextBox3" runat="server" class="custom-textbox"></asp:TextBox>
		    <br />
            course name:<asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="TextBox4" ErrorMessage="RequiredFieldValidator" ForeColor="Red">*</asp:RequiredFieldValidator>
            <br />
            <asp:TextBox ID="TextBox4" runat="server" class="custom-textbox"></asp:TextBox>
		    <br />
            <asp:CheckBox ID="CheckBox1" runat="server" Text="Is offered: " TextAlign="Left" />
            <br />
            <asp:Button ID="Button1" runat="server" Text="Add course" class="small-button" OnClick="ADD_COURSE"/>
		    <asp:Label ID="Label1" runat="server" ForeColor="#66FF33" Text="DONE" Visible="False"></asp:Label>
		</form>
