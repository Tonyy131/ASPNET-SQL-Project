<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InstructorStudent.aspx.cs" Inherits="Advising_Team_74.InstructorStudent" %>
...
<html lang="en">
  ...
  <body>
    ...
    <h2 class="mb-4">Instructor&#39;s Slots:</h2>
...
&nbsp;<asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="courseID" Display="Dynamic" ErrorMessage="RegularExpressionValidator" ForeColor="Red" ValidationExpression="\d+" ValidationGroup="course">*</asp:RegularExpressionValidator>
		...
		<asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ControlToValidate="inst" Display="Dynamic" ErrorMessage="RegularExpressionValidator" ForeColor="Red" ValidationExpression="\d+" ValidationGroup="course">*</asp:RegularExpressionValidator>
        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="inst" Display="Dynamic" ErrorMessage="RequiredFieldValidator" ForeColor="Red" ValidationGroup="course">*</asp:RequiredFieldValidator>
		<br /> <asp:TextBox ID="inst" class="custom-textbox" runat="server"></asp:TextBox> 
		<br /> <br />
        <asp:Button ID="showss" class="small-button" runat="server" Text="Show" OnClick="show" ValidationGroup="course" />
