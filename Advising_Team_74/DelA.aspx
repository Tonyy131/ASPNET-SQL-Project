<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DelA.aspx.cs" Inherits="Advising_Team_74.DelA" %>
...
<html lang="en">
  ...
  <body>
    ...
    <h2 class="mb-4">Delete course from a graduation plan</h2>
  ...
  <br />
         course ID :
		<asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="cid" Display="Dynamic" ErrorMessage="RequiredFieldValidator" ForeColor="Red" ValidationGroup="course">*</asp:RequiredFieldValidator>
         <asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" ControlToValidate="cid" Display="Dynamic" ErrorMessage="RegularExpressionValidator" ForeColor="Red" ValidationExpression="\d+" ValidationGroup="course">*</asp:RegularExpressionValidator>
		<br /> <asp:TextBox ID="cid" class="custom-textbox" runat="server"></asp:TextBox> <br />
		<asp:Label ID="Label1" runat="server" Font-Size="Small" ForeColor="#66FF33" Text="Done" Visible="False"></asp:Label>
		&nbsp;<asp:Label ID="Label2" runat="server" Font-Size="Small" ForeColor="Red" Text="student id or course id is wrong" Visible="False"></asp:Label>
		<br />
		<asp:Button ID="RequestCourse" class="small-button" runat="server" Text="Delete" OnClick="Delete_Course_Graduation" ValidationGroup="course" />
