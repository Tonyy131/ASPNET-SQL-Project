<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InstallmentStudent.aspx.cs" Inherits="Advising_Team_74.InstallmentStudent" %>
...
<html lang="en">
  ...
  <body>
    ...
    <h2 class="mb-4">Next Installment:</h2>
    <div style="font-family: 'Sitka Heading'; font-size: xx-large; font-weight: bolder; text-transform: uppercase; color: #000080;">
       
        Deadline:
       
        <asp:Label ID="deadlineLabel" runat="server" Text="deadline" ForeColor="#CC6600"></asp:Label>
        <br />
        amount:
        <asp:Label ID="amountLabel" runat="server" Text="amount" ForeColor="#CC6600"></asp:Label>
        <br />
