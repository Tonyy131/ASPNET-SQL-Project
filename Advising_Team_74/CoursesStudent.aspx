<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CoursesStudent.aspx.cs" Inherits="Advising_Team_74.CoursesStudent" %>
<!doctype html>
<html lang="en">
  <head>
  ...
  <body>
        ...
        <!-- Four big attractive buttons -->
		<form id="form1" runat="server">
        <div class="button-container">
          <asp:Button ID="ViewOptionalCoursesButton" class="big-button" runat="server" Text="View All Optional Courses" OnClick="viewOptionalCourses" />
         <asp:Button ID="ViewAvailableCourses" class="big-button" runat="server" Text="View All Available Courses" OnClick="viewAvailableCourses" />
          <asp:Button ID="ViewRequiredCourses" class="big-button" runat="server" Text="View All Required Courses" OnClick="viewRequiredCourses" />
          <asp:Button ID="ViewMissingCourses" class="big-button" runat="server" Text="View All Missing Courses" OnClick="viewMissingCourses" />
        </div>
