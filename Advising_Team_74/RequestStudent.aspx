<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RequestStudent.aspx.cs" Inherits="Advising_Team_74.RequestStudent" %>
<!doctype html>
<html lang="en">
  <head>
  ...
  <body>
    ...
    <!-- Additional content or formatting here -->
        ...
        <asp:Label ID="Label1" runat="server" Font-Size="Small" ForeColor="#66FF33" Text="Request sent successfully" Visible="False"></asp:Label>
        <asp:Label ID="Label3" runat="server" Font-Size="Small" ForeColor="Red" Text="course id is not found" Visible="False"></asp:Label>
		<br />
        <asp:Button ID="RequestCourse" class="small-button" runat="server" Text="Send a course request" OnClick="RequestCr" ValidationGroup="course" />
        

		<br />
        No. of credit hours:
		<asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ControlToValidate="creditH" Display="Dynamic" ErrorMessage="RegularExpressionValidator" ForeColor="Red" ValidationExpression="\d+" ValidationGroup="credit">*</asp:RegularExpressionValidator>
        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="creditH" Display="Dynamic" ErrorMessage="RequiredFieldValidator" ForeColor="Red" ValidationGroup="credit">*</asp:RequiredFieldValidator>
		<br /> <asp:TextBox ID="creditH" class="custom-textbox" runat="server"></asp:TextBox>
			<br />Comment :
		<br /> <asp:TextBox ID="comm0" class="custom-textbox" runat="server"></asp:TextBox> <br />
        <asp:Label ID="Label2" runat="server" Font-Size="Small" ForeColor="#66FF33" Text="Request sent successfully" Visible="False"></asp:Label>
		<br />
        <asp:Button ID="RequestCreditHours" class="small-button" runat="server" Text="Send extra credit hours request" OnClick="RequestCH" ValidationGroup="credit" />
