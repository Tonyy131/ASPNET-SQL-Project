<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="delete1.aspx.cs" Inherits="Advising_Team_74.delete1" %>
...
<html lang="en">
  ...
  <body>
    ...
    <!-- Additional content or formatting here -->
        semester code:<asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="textboxx" ErrorMessage="RequiredFieldValidator" ForeColor="Red">*</asp:RequiredFieldValidator>
        <br />
        <asp:TextBox ID="textboxx" runat="server" class="custom-textbox"></asp:TextBox>
        <asp:Label ID="Label1" runat="server" Font-Size="Small" ForeColor="#66FF33" Text="Done" Visible="False"></asp:Label>
        <br />
        <br />
        <asp:Button ID="Button1" runat="server" Text="Delete" class="small-button" OnClick="Delete_Slot_Certain_Course"/>
</div>
		</div>
