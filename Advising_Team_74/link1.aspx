<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="link1.aspx.cs" Inherits="Advising_Team_74.link1" %>
...
<html lang="en">
  ...
  <body>
    ...
    <h2 class="mb-4">Link student to advisor :</h2>
    <div style="font-family: 'Sitka Heading'; font-size: xx-large; font-weight: bolder; text-transform: uppercase; color: #000080;">
        <form id="form1" runat="server">
		    Student id:<asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="ins" ErrorMessage="RequiredFieldValidator" ForeColor="Red">*</asp:RequiredFieldValidator>
		    ...
		    <br />
 advisor id:<asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="TextBox2" ErrorMessage="RequiredFieldValidator" ForeColor="Red">*</asp:RequiredFieldValidator>
            ...
            <asp:Button ID="Button1" runat="server" Text="Link" class="small-button" OnClick="Link_student_to_advisor" Height="74px"/>
		</form>
