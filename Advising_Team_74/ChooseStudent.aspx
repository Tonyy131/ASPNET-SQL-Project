<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ChooseStudent.aspx.cs" Inherits="Advising_Team_74.ChooseStudent" %>
...
<html lang="en">
  ...
  <body>
    ...
    <h2 class="mb-4">Choose Instructor :</h2>
...
<br /> <asp:TextBox ID="courseID" class="custom-textbox" runat="server"></asp:TextBox>
	<br />course id :
<asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ControlToValidate="comm" Display="Dynamic" ErrorMessage="RegularExpressionValidator" ForeColor="Red" ValidationExpression="\d+" ValidationGroup="course">*</asp:RegularExpressionValidator>
...
<asp:Label ID="Label2" runat="server" Font-Size="Small" ForeColor="Red" Text="Couldn't find the course!" Visible="False"></asp:Label>
<br />
<asp:Button ID="RequestCourse" class="small-button" runat="server" Text="Submitt" OnClick="Choose" ValidationGroup="course" />
</div>
		</div>
