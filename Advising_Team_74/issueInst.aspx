<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="issueInst.aspx.cs" Inherits="Advising_Team_74.issueInst" %>
...
<html lang="en">
  ...
  <body>
    ...
    <h2 class="mb-4">Issue installments</h2>
    ...
    <!-- Additional content or formatting here -->
        Payment id:<asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="TextBox1" ErrorMessage="RequiredFieldValidator" ForeColor="Red">*</asp:RequiredFieldValidator>
...
&nbsp;<asp:Label ID="Label2" runat="server" Font-Size="Small" ForeColor="Red" Text="Cannot issue installment" Visible="False"></asp:Label>
        <br />
        <br />
        <asp:Button ID="Button1" runat="server" Text="Issue" class="small-button" OnClick="Issue_Installments_Certain_Payment"/>
</div>
		</div>
