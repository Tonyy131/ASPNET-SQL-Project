<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="addSem.aspx.cs" Inherits="Advising_Team_74.addSem" %>
...
<html lang="en">
  ...
  <body>
    ...
    <h2 class="mb-4">Add new semester</h2>
    <div style="font-family: 'Sitka Heading'; font-size: xx-large; font-weight: bolder; text-transform: uppercase; color: #000080;">
        <form id="form1" runat="server">
		    Start date:<asp:Calendar ID="Calendar1" runat="server" BackColor="White" BorderColor="#3366CC" BorderWidth="1px" CellPadding="1" DayNameFormat="Shortest" Font-Names="Verdana" Font-Size="8pt" ForeColor="#003399" Height="200px" Width="476px">
            ...
            <br />
            End date:<asp:Calendar ID="Calendar2" runat="server" BackColor="White" BorderColor="#3366CC" BorderWidth="1px" CellPadding="1" DayNameFormat="Shortest" Font-Names="Verdana" Font-Size="8pt" ForeColor="#003399" Height="200px" Width="476px">
                <DayHeaderStyle BackColor="#99CCCC" ForeColor="#336666" Height="1px" />
                <NextPrevStyle Font-Size="8pt" ForeColor="#CCCCFF" />
                <OtherMonthDayStyle ForeColor="#999999" />
                <SelectedDayStyle BackColor="#009999" Font-Bold="True" ForeColor="#CCFF99" />
            ...
            <br />
            Semester code:<asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="TextBox1" ErrorMessage="RequiredFieldValidator" ForeColor="Red">*</asp:RequiredFieldValidator>
            <br />
            <asp:TextBox ID="TextBox1" runat="server" class="custom-textbox"></asp:TextBox>
		    <br />
            <asp:Label ID="Label1" runat="server" Text="Semester added successfully" ForeColor="#66FF33" Font-Size="Small" Visible="False"></asp:Label>
            <asp:Label ID="Label2" runat="server" Text="start date must be before the end date" ForeColor="Red" Font-Size="Small" Visible="False"></asp:Label>
            <br />
		    <asp:Button ID="Button1" runat="server" Text="ADD" class="small-button" OnClick="add_semester"/>
		</form>
