<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MajorA.aspx.cs" Inherits="Advising_Team_74.MajorA" %>
...
<html lang="en">
  ...
  <body>
    ...
    <h2 class="mb-4">Major&#39;s Students</h2>
    ...
    <!-- Additional content or formatting here -->
        ...
        <br />
        <asp:TextBox ID="TextBox1" class="custom-textbox" runat="server"></asp:TextBox>
		<br /> <asp:GridView ID="YourGridView" CssClass="grid-container" runat="server" ClientIDMode="Static" AutoGenerateColumns="true" OnSelectedIndexChanged="YourGridView_SelectedIndexChanged"></asp:GridView> <br />
		<asp:Button ID="Button1" class="small-button" runat="server" Text="Show" OnClick="Advising_Students_Certain_Major"/>
